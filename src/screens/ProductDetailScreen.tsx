...
const styles = StyleSheet.create({
  ...
  proBadgeImg: {
    position: 'absolute', top: 12, right: 12, backgroundColor: C.TEAL,
    borderRadius: borderRadius.pill, paddingHorizontal: 10, paddingVertical: 4,
  },
  proBadgeImgText: { color: C.BG, fontSize: 11, fontWeight: '800' },
  infoPanel: { flex: 1 },
  ...
  proAlert: {
    backgroundColor: C.TEAL + '22', borderWidth: 1, borderColor: C.TEAL + '66',
    borderRadius: borderRadius.lg, padding: 10, marginBottom: 12,
  },
  proAlertText: { color: C.TEAL, fontSize: 13, fontWeight: '700' },
